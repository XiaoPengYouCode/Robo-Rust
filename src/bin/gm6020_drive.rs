...
use roborust::modules::motors::dji_motors::gm6020::{ReductionGearboxTransmissionRatio, Rm3508};
...
async fn main(_spawner: Spawner) {
    ...
    loop {
        ...
        let target_speed = 3000;

        rm3508_1
            .speed_control(target_speed, current_speed, current_current)
            .await;

        if current_speed > 0x1770 || current_speed < -0x1770 {
